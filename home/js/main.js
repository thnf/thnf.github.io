...
const add_id = "ljwushkfoqpqqiuh"; // app_id
const app_secret = "UjBINWlqb1ZhckxSbnhqdTZnd25ZUT09"; // app_secret
const key = "29cefc8cd91e471ab1e5aaf107a12320" // key
function getWeather() {
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("贝浦熙（Earthnfc）");
        $("#change1").html("哎呀，这都被你发现了（ 再点击一次可关闭 ）");
    } else {
        $('#container').attr('class', 'container');
        $("#change").html("贝浦熙（Earthnfc）");
        $("#change1").html("一个建立于 21 世纪的网站");
    }
});
